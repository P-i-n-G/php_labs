...
<head>
  <meta charset="UTF-8">
  <title>PHP Labs | Chall 3 ~ Magic Hash</title>
  <meta charset="utf-8">
            ...
            <div class="column-child terminal shadow">
              ...
              <div class="terminal-window primary-bg" onclick="document.getElementById('dummyKeyboard').focus();">
                <div class="terminal-line">
                  <form name="myForm" action="3.php" method="">
                    <div class="siimple-form">
                      <span class="help-msg">Chall 3 — Clue : <span class="code">Magic Hash</span> </span>
                      <br><br>
                      <div class="siimple-form-field">
                        <input type="text" class="siimple-input siimple-input--fluid" placeholder="String" name="String"> String
                      </div>
                  ...
                  if (isset($_GET['String'])) {
                    ...
                    echo "<div style=\"text-align:left;font-size:1em;\">Silahkan masukkan string yang ingin di-hash!</div>";
                  }
                  ?>
                  <br>
