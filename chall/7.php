...
<head>
  <meta charset="UTF-8">
  <title>PHP Labs | Chall 7 ~ Tipe Data</title>
  <meta charset="utf-8">
            ...
            <div class="column-child terminal shadow">
              ...
              <div class="terminal-window primary-bg" onclick="document.getElementById('dummyKeyboard').focus();">
                <div class="terminal-line">
                  <form name="myForm" action="7.php" method="get">
                    <div class="siimple-form">
                      <span class="help-msg">Chall 7 — Clue : <span class="code">Tipe Data</span> </span>
                      <br><br>
                  ...
                  if (isset($_GET['Angka'])) {
                    $angka = $_GET['Angka'];
                    if (strlen($angka) < 5) {
                      if (hexdec($angka) > 10000){
                        echo "<script>alert('Selamat Kamu berhasil!')</script>";
                      } else {
                      echo "<script>alert('Yah, kamu masih gagal :(')</script>";
                    }}
                  } else {
                    echo "<div style=\"text-align:left;font-size:1em;\">Masukkkan angka lebih dari 10000!</div>";
                  }
                  ?>
                  <br>
